...
export async function fetchReportData(reportType) {
    ...
    try {
        ...
        console.log('Just a little peak into the responce: ', response)
        if (!response.ok) {
        ...
        console.log("Updated state with report data:", globalState.getState());
        console.log('reportData just after return: ', reportData)
        ...
        globalState.setState({
            reportData,
            dataHold: reportData, // Keep a master copy
